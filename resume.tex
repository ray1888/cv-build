...
\begin{itemize}
  \item Implemented feature
         1. Ceph iSCSI Monitor with iSCSI client counter 
         2. NAS(network attach storage) Performance Monitor (including nfs & cifs)  
         3. Cephx Management in api & ui 
         4. Batch install without add ssh key with concurrency control & node recovery
         5. the resource failure & restart speed with optimize the RCM(Resource Control Manager) process FSM
